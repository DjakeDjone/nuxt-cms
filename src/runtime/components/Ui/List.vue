...
onMounted(() => {
  ...
  items.value.forEach((item, index) => {
    ...
    item.style.transition = `opacity ${props.animationDurationMs || 300}ms cubic-bezier(0.25, 0.46, 0.45, 0.94), transform ${props.animationDurationMs || 300}ms cubic-bezier(0.25, 0.46, 0.45, 0.94)`
